...
def havel_hakimi(arr):
   ...
   while(True):
      ...
      # remove first value in sequence, make it n
      n = arr[0]
      arr.remove(n)

      # if n is greater than length of sequence return false
      if lengthCheck(n, arr):
         return False
      
      # subract 1 from every element in sequence
      arr = frontElimnation(n, arr)

# print(removeZeroes([5, 3, 0, 2, 6, 2, 0, 7, 2, 5]))
# print(removeZeroes([4, 0, 0, 1, 3]))
# print(removeZeroes([1, 2, 3]))
# print(removeZeroes([0, 0, 0]))
# print(removeZeroes([]))

# print(reverseSort([5, 1, 3, 4, 2]))
# print(reverseSort([0, 0, 0, 4, 0]))
# print(reverseSort([1]))
# print(reverseSort([]))

# print(lengthCheck(7, [6, 5, 5, 3, 2, 2, 2]))
# print(lengthCheck(5, [5, 5, 5, 5, 5]))
# print(lengthCheck(5, [5, 5, 5, 5]))
# print(lengthCheck(3, [1, 1]))
# print(lengthCheck(1, []))
# print(lengthCheck(0, []))

# print(frontElimnation(4, [5, 4, 3, 2, 1]))
# print(frontElimnation(11, [14, 13, 13, 13, 12, 10, 8, 8, 7, 7, 6, 6, 4, 4, 2]))
# print(frontElimnation(1, [10, 10, 10]))
# print(frontElimnation(3, [10, 10, 10]))
# print(frontElimnation(1, [1]))
...
print(havel_hakimi([14, 10, 17, 13, 4, 8, 6, 7, 13, 13, 17, 18, 8, 17, 2, 14, 6, 4, 7, 12]))
print(havel_hakimi([15, 18, 6, 13, 12, 4, 4, 14, 1, 6, 18, 2, 6, 16, 0, 9, 10, 7, 12, 3]))
print(havel_hakimi([6, 0, 10, 10, 10, 5, 8, 3, 0, 14, 16, 2, 13, 1, 2, 13, 6, 15, 5, 1]))
print(havel_hakimi([2, 2, 0]))
print(havel_hakimi([3, 2, 1]))
